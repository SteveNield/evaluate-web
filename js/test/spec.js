...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcComponentsLoginFormJs = __webpack_require__(177);

	var _srcComponentsLoginFormJs2 = _interopRequireDefault(_srcComponentsLoginFormJs);
	...
	describe('LoginForm', function () {
	    ...
	    it('should getInitialState containing username, password and loginButtonClass', function () {
	        var expectedState = { username: '', password: '' };

	        expect(_srcComponentsLoginFormJs2['default'].prototype.getInitialState()).toEqual(expectedState);
	    });

	    it('should set username in state when username field is changed', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], null));
	    ...
	    it('should set password in state when password field is changed', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], null));
	    ...
	    it('should resolve loginButtonClass to "button button-disabled" when username is empty', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], null));
	    ...
	    it('should set loginButtonClass to "button button-disabled" when password is empty', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], null));
	    ...
	    it('should set loginButtonClass to "button button-green" when username and password are set', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], null));
	    ...
	    it('should post username and password to source URL on button click', function () {
	        var mockDataService = {
	        ...
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], { dataService: mockDataService, source: 'MOCK_URL' }));

	        component.setState({ username: 'username', password: 'password' });

	        component.handleLogin();

	        expect(mockDataService.post).toHaveBeenCalledWith('MOCK_URL', { Username: 'username', Password: 'password' }, component.handleSuccessfulLogin, component.handleFailedLogin);
	    });

	    it('should alert a general error if login failed', function () {
	        var mockErrorAlert = { alert: function alert() {} };

	        spyOn(mockErrorAlert, 'alert');

	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], { errorAlert: mockErrorAlert }));
	    ...
	    it('should add the token to the tokenRepo and route to #dashboard if login succeeded', function () {
	        var mockTokenRepo = { put: function put() {} };
	        var mockRoutie = { goTo: function goTo() {} };

	        spyOn(mockTokenRepo, 'put');
	        spyOn(mockRoutie, 'goTo');

	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsLoginFormJs2['default'], { tokenRepo: mockTokenRepo, routie: mockRoutie }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactComponentWithPureRenderMixin = __webpack_require__(163);
	var ReactCSSTransitionGroup = __webpack_require__(165);
	var ReactFragment = __webpack_require__(171);
	...
	var shallowCompare = __webpack_require__(164);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHeaderJs = __webpack_require__(179);
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    resolveLoginButtonClass: function resolveLoginButtonClass() {
	    ...
	    handleLogin: function handleLogin() {
	        ...
	        this.props.dataService.post(this.props.source, loginAttempt, this.handleSuccessfulLogin, this.handleFailedLogin);
	    },

	    handleSuccessfulLogin: function handleSuccessfulLogin(data) {
	        this.props.tokenRepo.put(data);
	        this.props.routie.goTo('dashboard');
	    },

	    handleFailedLogin: function handleFailedLogin(xhr) {
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    'h2',
	                    { className: 'center-text form-header' },
	                    'Welcome'
	                ),
	                _react2['default'].createElement(
	                    'h4',
	                    { className: 'center-text form-sub-header' },
	                    'Enter your credentials below'
	                ),
	                _react2['default'].createElement('input', { id: 'username', className: 'form-username', type: 'text', placeholder: 'Username', onChange: this.handleInput, value: this.state.username }),
	                _react2['default'].createElement('input', { id: 'password', className: 'form-password', type: 'password', placeholder: 'Password', onChange: this.handleInput, value: this.state.password }),
	                _react2['default'].createElement(
	                    'a',
	                    { href: '#', className: this.resolveLoginButtonClass(), onClick: this.handleLogin },
	                    'Login'
	                )
	            )
	        );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcComponentsDashboardJs = __webpack_require__(181);
	...
	describe('Dashboard', function () {
	    var component, token, courses, tokenRepo, dataService, source;
	    ...
	    beforeEach(function () {
	        ...
	        dataService = {
	            get: function get(url, token, success, fail) {
	                return [];
	            }
	        };
	    });

	    it('should display a header with "Welcome to the Dashboard"', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsDashboardJs2['default'], { tokenRepo: tokenRepo, dataService: dataService, source: source }));

	        expect(component.getDOMNode('header').textContent).toMatch('Welcome to the Dashboard');
	    });

	    it('has a displayName of "Dashboard"', function () {
	        expect(_srcComponentsDashboardJs2['default'].displayName).toMatch('Dashboard');
	    });

	    it('should set an empty array of courses as the initialState', function () {
	        expect(_srcComponentsDashboardJs2['default'].prototype.getInitialState()).toEqual({ courses: courses });
	    });

	    it('should call dataService.get() with the correct parameters', function () {
	        ...
	        expect(dataService.get).toHaveBeenCalledWith(source, token, component.handleSuccessfulLoad, component.handleFailToLoad);
	    });

	    it('should setState to argument if component is mounted on successful load', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsDashboardJs2['default'], { tokenRepo: tokenRepo, dataService: dataService, source: source }));

	        component.isMounted = function () {
	            return true;
	        };
	    ...
	    it('should not call setState is component is not mounted on successful load', function () {
	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsDashboardJs2['default'], { tokenRepo: tokenRepo, dataService: dataService, source: source }));
	    ...
	    it('should pass the response to the serverErrorHandler on failed load', function () {
	        var serviceErrorHandler = {
	            handle: function handle(xhr) {}
	        };

	        var xhr = 'MOCK_RESPONSE';

	        component = TestUtils.renderIntoDocument(_reactAddons2['default'].createElement(_srcComponentsDashboardJs2['default'], {
	            tokenRepo: tokenRepo,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	    ...
	    componentDidMount: function componentDidMount() {
	        var courses = this.props.dataService.get(this.props.source, this.props.tokenRepo.get(), this.handleSuccessfulLoad, this.handleFailToLoad);
	    },

	    handleSuccessfulLoad: function handleSuccessfulLoad(data) {
	        if (this.isMounted()) {
	            this.setState({ courses: data });
	        }
	    },

	    handleFailToLoad: function handleFailToLoad(xhr, status, err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcComponentsHeaderJs = __webpack_require__(179);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcRepositoriesTokenRepoJs = __webpack_require__(184);

	var _srcRepositoriesTokenRepoJs2 = _interopRequireDefault(_srcRepositoriesTokenRepoJs);

	describe('Token Repository', function () {
	    ...
	    beforeEach(function () {
	        token = "TEST_TOKEN";
	        tokenRepo = new _srcRepositoriesTokenRepoJs2['default']();
	    });
	    ...
	    it('should put a given token in localStorage', function () {
	        tokenRepo.put(token);
	        expect(window.localStorage.getItem('currentToken')).toMatch(token);
	    });

	    it('should get a token from localStorage if one exists', function () {
	        window.localStorage.setItem('currentToken', token);
	        var retrievedToken = tokenRepo.get();
	        expect(retrievedToken).toMatch(token);
	    });

	    it('should get no token from localStorage if one does not exist', function () {
	        window.localStorage.removeItem('currentToken');
	        var retrievedToken = tokenRepo.get();
	        expect(retrievedToken).toEqual(null);
	    });

	    it('should indicate a token is present if one exists', function () {
	        window.localStorage.setItem('currentToken', token);
	        expect(tokenRepo.hasToken()).toEqual(true);
	    });

	    it('should indicate a token is not present if one does not exist', function () {
	        window.localStorage.removeItem('currentToken');
...
/***/ function(module, exports) {
	...
	var tokenRepo = (function () {
	    function tokenRepo() {
	        _classCallCheck(this, tokenRepo);
	    }

	    _createClass(tokenRepo, [{
	        key: 'put',
	        value: function put(token) {
	            window.localStorage.setItem('currentToken', token);
	        }
	    }, {
	        key: 'get',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcRoutingRouteHandlerJs = __webpack_require__(186);

	var _srcRoutingRouteHandlerJs2 = _interopRequireDefault(_srcRoutingRouteHandlerJs);
	...
	describe('Route Handler', function () {
	    ...
	    beforeEach(function () {
	        routieWrapper = { goTo: function goTo(route) {} };
	    });

	    it('default should route to dashboard when token is present', function () {
	        var tokenRepo = { hasToken: function hasToken() {
	                return true;
	            } };

	        spyOn(routieWrapper, "goTo");

	        var routeHandler = new _srcRoutingRouteHandlerJs2['default'](tokenRepo, routieWrapper);
	        routeHandler['default']();

	        expect(routieWrapper.goTo).toHaveBeenCalledWith('dashboard');
	    });

	    it('default should route to login when token is not present', function () {
	        var tokenRepo = { hasToken: function hasToken() {
	                return false;
	            } };
...
/***/ function(module, exports) {
	...
	var routeHandler = (function () {
	    function routeHandler(tokenRepo, routieWrapper) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcServicesDataServiceJs = __webpack_require__(188);

	var _srcServicesDataServiceJs2 = _interopRequireDefault(_srcServicesDataServiceJs);

	describe('Data Service', function () {

	    var jqWrapper, routie, mockUrl, errorAlert, mockToken, mockPayload, mockSuccess, mockFail;
	    ...
	    beforeEach(function () {
	        ...
	        errorAlert = { alert: function alert() {} };

	        mockUrl = 'MOCK_URL';
	        mockToken = 'MOCK_TOKEN';
	        mockPayload = 'MOCK_PAYLOAD';
	        mockSuccess = function () {
	            return 'SUCCESS';
	        };
	        mockFail = function () {
	            return 'FAIL';
	    ...
	    it('should call $.ajax when making a get with correct parameters', function () {
	        ...
	        var dataService = new _srcServicesDataServiceJs2['default'](jqWrapper, routie);
	    ...
	    it('should route get requests to #login if token is missing', function () {
	        spyOn(routie, "goTo");
	        ...
	        var dataService = new _srcServicesDataServiceJs2['default'](jqWrapper, routie, errorAlert);
	    ...
	    it('should call $.ajax when making a post with correct parameters', function () {
	        var expectedParameters = {
	            url: mockUrl,
	            data: mockPayload,
	            dataType: 'json',
...
/***/ function(module, exports) {
	...
	var secureDataService = (function () {
	    function secureDataService(jq, routie, errorAlert) {
	        _classCallCheck(this, secureDataService);
	    ...
	    _createClass(secureDataService, [{
	        key: 'get',
	        value: function get(url, token, success, fail) {
	        ...
	        key: 'post',
	        value: function post(url, data, success, fail) {
	...
	exports['default'] = secureDataService;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcServicesServiceErrorHandlerJs = __webpack_require__(190);

	var _srcServicesServiceErrorHandlerJs2 = _interopRequireDefault(_srcServicesServiceErrorHandlerJs);

	describe('Service Error Handler', function () {

	    var xhr, routie, errorAlert;
	    ...
	    it('should alert with the correct message for a 401', function () {

	        spyOn(errorAlert, "alert");
	        xhr = { status: 401 };

	        var serviceErrorHandler = new _srcServicesServiceErrorHandlerJs2['default'](routie, errorAlert);
	        serviceErrorHandler.handle(xhr);

	        expect(errorAlert.alert).toHaveBeenCalledWith('Unauthorized, please log in');
	    });

	    it('should alert with a general error message for an unhandled status', function () {
	    ...
	    if (('should route to login for a 401', function () {
	        spyOn(routie, "goTo");
	        xhr = { status: 401 };
...
/***/ function(module, exports) {
	...
	var serviceErrorHandler = (function () {
	    function serviceErrorHandler(routie, errorAlert) {
	        _classCallCheck(this, serviceErrorHandler);

	        this.routie = routie;
	        this.errorAlert = errorAlert;
	    }

	    _createClass(serviceErrorHandler, [{
	        key: 'handle',
	        value: function handle(xhr) {
