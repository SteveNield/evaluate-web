...
/***/ function(module, exports, __webpack_require__) {
	...
	var _srcConfigRoutieConfigJs = __webpack_require__(1);

	var _srcConfigRoutieConfigJs2 = _interopRequireDefault(_srcConfigRoutieConfigJs);

	var _srcLibRoutie = __webpack_require__(160);

	var _srcLibRoutie2 = _interopRequireDefault(_srcLibRoutie);

	var _srcConfigIocConfigJs = __webpack_require__(164);

	var _srcConfigIocConfigJs2 = _interopRequireDefault(_srcConfigIocConfigJs);

	var tokenRepo = _srcConfigIocConfigJs2['default'].resolve('tokenRepo'),
	    routeHandler = _srcConfigIocConfigJs2['default'].resolve('routeHandler');

	_srcConfigRoutieConfigJs2['default'].configure();
	tokenRepo.clear();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libRoutieJs = __webpack_require__(160);

	var _libRoutieJs2 = _interopRequireDefault(_libRoutieJs);

	var _componentsLoginFormJs = __webpack_require__(161);

	var _componentsLoginFormJs2 = _interopRequireDefault(_componentsLoginFormJs);

	var _componentsDashboardJs = __webpack_require__(163);

	var _componentsDashboardJs2 = _interopRequireDefault(_componentsDashboardJs);

	var _configIocConfigJs = __webpack_require__(164);

	var _configIocConfigJs2 = _interopRequireDefault(_configIocConfigJs);

	exports['default'] = {

	    configure: function configure() {

	        var dataService = _configIocConfigJs2['default'].resolve('dataService'),
	            serviceConfig = _configIocConfigJs2['default'].resolve('serviceConfig'),
	            tokenRepo = _configIocConfigJs2['default'].resolve('tokenRepo'),
	            routieWrapper = _configIocConfigJs2['default'].resolve('routie'),
	            errorAlert = _configIocConfigJs2['default'].resolve('errorAlert'),
	            serviceErrorHandler = _configIocConfigJs2['default'].resolve('serviceErrorHandler');

	        routie({
	            'login': function login() {
	                _reactDom2['default'].render(_react2['default'].createElement(_componentsLoginFormJs2['default'], {
	            ...
	            'dashboard': function dashboard() {
	                _reactDom2['default'].render(_react2['default'].createElement(_componentsDashboardJs2['default'], {
	                    tokenRepo: tokenRepo,
	                    dataService: dataService,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsHeaderJs = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libIocJs = __webpack_require__(165);

	var _libIocJs2 = _interopRequireDefault(_libIocJs);

	var _toastr = __webpack_require__(166);
	...
	var _routingRouteHandlerJs = __webpack_require__(169);

	var _routingRouteHandlerJs2 = _interopRequireDefault(_routingRouteHandlerJs);

	var _repositoriesTokenRepoJs = __webpack_require__(170);

	var _repositoriesTokenRepoJs2 = _interopRequireDefault(_repositoriesTokenRepoJs);

	var _routingRoutieWrapperJs = __webpack_require__(171);

	var _routingRoutieWrapperJs2 = _interopRequireDefault(_routingRoutieWrapperJs);

	var _errorHandlingErrorAlertJs = __webpack_require__(172);

	var _errorHandlingErrorAlertJs2 = _interopRequireDefault(_errorHandlingErrorAlertJs);

	var _servicesDataServiceJs = __webpack_require__(173);

	var _servicesDataServiceJs2 = _interopRequireDefault(_servicesDataServiceJs);

	var _servicesServiceErrorHandlerJs = __webpack_require__(174);

	var _servicesServiceErrorHandlerJs2 = _interopRequireDefault(_servicesServiceErrorHandlerJs);

	var _configServiceConfigJs = __webpack_require__(175);

	var _configServiceConfigJs2 = _interopRequireDefault(_configServiceConfigJs);

	var _configEnvironmentConfigJs = __webpack_require__(176);

	var _configEnvironmentConfigJs2 = _interopRequireDefault(_configEnvironmentConfigJs);

	var ioc = new _libIocJs2['default']();
	console.log(_jquery2['default'].ajax);

	ioc.registerType('toastr', _toastr2['default']);
	ioc.registerType('jQuery', { $: _jquery2['default'] });

	ioc.registerType('routeHandler', _routingRouteHandlerJs2['default']);
	ioc.registerType('tokenRepo', _repositoriesTokenRepoJs2['default']);
	ioc.registerType('routie', _routingRoutieWrapperJs2['default']);
	ioc.registerType('errorAlert', _errorHandlingErrorAlertJs2['default']);
	ioc.registerType('dataService', _servicesDataServiceJs2['default']);
	ioc.registerType('serviceErrorHandler', _servicesServiceErrorHandlerJs2['default']);

	ioc.registerType('serviceConfig', _configServiceConfigJs2['default']);
	ioc.registerType('baseSourceUri', _configEnvironmentConfigJs2['default'].baseSourceUri);
	ioc.registerType('loginUri', _configEnvironmentConfigJs2['default'].loginUri);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* global define */
	; (function (define) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(167)], __WEBPACK_AMD_DEFINE_RESULT__ = function ($) {
	        return (function () {
	            var $container;
	            var listener;
	            var toastId = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var routieWrapper = (function () {
	    function routieWrapper() {
	        _classCallCheck(this, routieWrapper);
	    }

	    _createClass(routieWrapper, [{
	        key: 'goTo',
	    ...
	    return routieWrapper;
	})();

	exports['default'] = routieWrapper;
	module.exports = exports['default'];
...
/***/ function(module, exports) {
	...
	var ServiceConfig = (function () {
	    function ServiceConfig(baseUri, loginUri) {
	    ...
	    _createClass(ServiceConfig, [{
	        key: 'resolveEndpoint',
	        value: function resolveEndpoint(endpoint) {
...
/***/ function(module, exports) {
	...
	exports["default"] = {
	    baseSourceUri: "http://localhost/evaluate-api/",
	    loginUri: "http://localhost/winter-auth/login"
	};
	module.exports = exports["default"];
